...
export const products = [
  ...
  },
  {
    ...
    description: "Battery-operated free-standing table-top illuminated display. Perfect for counters, reception desks, cafés and product showcases.",
    features: ["A4 size", "Battery operated", "Free-standing base", "Interchangeable print", "Compact footprint"],
  ...
  },
  {
    ...
    description: "Battery-operated portable table-top glowbox with 4–5 hour backup. Ideal for events, counters and mobile displays.",
  ...
  },
  {
    ...
    description: "Fully customized large format glowbox. Maximum size 2 × 6 ft. Priced at ₹900 per sq ft. Ideal for floor standees, mall displays and large commercial branding.",
    features: ["Fully custom size", "Maximum 2 × 6 ft", "Floor standee options", "Commercial grade"],
...
export const features = [
  ...
  { icon: "Ruler", title: "Any Size Possible", desc: "Expert custom manufacturing from A5 to 2 × 6 ft jumbo formats." },
];
