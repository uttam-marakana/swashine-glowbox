...
const img = {
  ...
  p2: gallery([
    ...
    "p2-24x36/36x24-inch-img1.jpg",
    "p2-24x36/36x24-inch-img2.png",
    "p2-24x36/36x24-inch-img3.jpg",
    "p2-24x36/36x24-inch-img4.jpg",
    "p2-24x36/36x24-inch-img5.jpg",
  ]),
  p3: gallery([
    "p3-24x42/24x42-inch-glowbox-img1.png",
    "p3-24x42/42x24-inch-img1.png",
    "p3-24x42/42x24-inch-img3.jpg",
    "p3-24x42/42x24-inch-img4.jpg",
    "p3-24x42/42x24-inch-img5.jpg",
  ]),
  p4: gallery([
    "p4-18x12/18x12_inch-glowbox-img.jpg",
    "p4-18x12/18x12_product_img1.jpg",
    "p4-18x12/18x12_product_img2.png",
    "p4-18x12/18x12_product_img3.jpg",
  ...
  p5: gallery([
    ...
    "p5-a4-tabletop/a4-tabletop-img5.jpg",
  ]),
  p6: gallery([
